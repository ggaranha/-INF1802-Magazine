...
public class MagazineSubscriber implements Flow.Subscriber<Integer>  {
    ...
    public void onNext(Integer item) {
        ...
        count++;
        if( item - lastItem > 1){
            log("O assinante " + this.getSubscriberName() + " perdeu uma revista.");
            lostMagazines++;
        }
    ...
    public void onComplete() {
        // @TODO
        System.out.println("O assinante "+ this.getSubscriberName()+" recebeu "+(count-lostMagazines)+" revistas.");
    }
